...
import { EligibilityResult } from 'apps/web/src/lib/check-eligibility';
...
export function BenefitDetailsPanel({
  benefit,
  existingRequest,
  rules,
  eligibility,
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <h3 className="text-[16px] font-normal text-[#262d39]">Description</h3>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <DetailRow
          ...
          value={
            benefit.subsidyPercent != null ? `${benefit.subsidyPercent}%` : null
          }
        />
      ...
      <div>
        ...
        {rules.length === 0 ? (
          ...
          <div className="mt-4 space-y-4">
            {rules.map((rule) => {
              const rulePassed = isRulePassing(rule, dialogMode, eligibility);
      ...
      {dialogMode === 'locked' && <LockedReasonCard unmetCount={unmetCount} />}
