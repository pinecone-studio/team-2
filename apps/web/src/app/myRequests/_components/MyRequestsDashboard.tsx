...
//   const { user } = useUser();
//   const [tab, setTab] = useState<RequestStatus>(RequestStatus.Pending);
...
//       <Tabs
//         value={tab}
//         onValueChange={(v) => setTab(v as RequestStatus)}
//         className="mb-6"
//       >
...
//                   statusStyles[RequestStatus.Pending];
//                 return (
//                   <tr
//                     key={request.id}
...
//                       {getBenefitCategory(request.benefitId)}
//                     </td>
//                     <td className="px-4 py-3 text-sm text-[#64748B]">
//                       {getBenefitVendor(request.benefitId)}
//                     </td>
//                     <td className="px-4 py-3 text-sm font-bold text-[#137FEC]">
//                       {getBenefitSubsidy(request.benefitId)}%
//                     </td>
//                     <td className="px-4 py-3 text-sm text-[#64748B]">
//                       {request.createdAt
...
//                       <span
//                         className={`px-[10px] py-1 rounded-lg text-[11px] font-semibold border capitalize ${style.badge}`}
//                       >
